...
- **Site** — structural graph explorer showing pages, partials, routes, tokens, and assets as an interactive hierarchy diagram with impact analysis, blast radius queries, page management (rename, change URL, move, delete with automatic reference cleanup), and an AI orchestration console for describing site-wide changes, reviewing edit plans, and applying them transactionally
