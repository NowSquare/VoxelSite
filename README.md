...
- **Site** — structural graph explorer showing pages, partials, routes, tokens, and assets as an interactive hierarchy diagram with impact analysis, blast radius queries, and page management (rename, change URL, move, delete with automatic reference cleanup)
