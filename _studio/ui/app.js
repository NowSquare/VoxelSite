...
function renderEmptyChat() {
  ...
  const designFoundation = [
    { label: 'Quiet gallery', prompt: 'Build my website so it feels like walking into a quiet gallery: lots of air, few words, one image at a time, nothing competing for attention. Decide the pages and sections from my site name and tagline.', type: 'create_site' },
    { label: 'Neighborhood cafe', prompt: 'Build my website so it feels like a busy neighborhood cafe at nine in the morning: warm, close-up, a little imperfect, full of specific details. Decide the pages and sections from my site name and tagline.', type: 'create_site' },
    { label: 'Magazine spread', prompt: 'Design my website like an editorial magazine spread: strong headline typography, a clear grid, generous margins, photography that gets room to breathe. Decide the pages and sections from my site name and tagline.', type: 'create_site' },
    { label: 'Well-run office', prompt: 'Build my website so it feels like a well-run professional office: calm, precise, trustworthy, no decoration for its own sake. The kind of site a lawyer or an accountant would be proud of. Decide the pages and sections from my site name and tagline.', type: 'create_site' },
    { label: 'Workshop, not showroom', prompt: 'Build my website so it feels like a working craft workshop rather than a showroom: honest materials, dark and warm, close-ups of the work, plain confident language. Decide the pages and sections from my site name and tagline.', type: 'create_site' },
    { label: 'Loud and joyful', prompt: 'Build my website loud and joyful: big type, two strong colors, an energetic rhythm, a sense of humor in the copy. Confident, not corporate. Decide the pages and sections from my site name and tagline.', type: 'create_site' },
    { label: 'Boutique hotel', prompt: 'Build my website so it feels like arriving at a small boutique hotel: unhurried, refined, warm and muted, elegant typography, a few beautiful photographs. Decide the pages and sections from my site name and tagline.', type: 'create_site' },
    { label: 'Product launch', prompt: 'Build my website like a focused product launch page: one clear promise at the top, proof and details below, a single obvious action, dark and sharp. Decide the pages and sections from my site name and tagline.', type: 'create_site' },
    { label: 'Farm stand', prompt: 'Build my website so it feels like a farm stand on a Saturday morning: earthy colors, natural textures, friendly hand-made character, straightforward information. Decide the pages and sections from my site name and tagline.', type: 'create_site' },
    { label: 'Record sleeve', prompt: 'Design my website with the character of a classic record sleeve: bold retro typography, a limited palette, one strong image, nostalgia without looking dated. Decide the pages and sections from my site name and tagline.', type: 'create_site' },
  ];
