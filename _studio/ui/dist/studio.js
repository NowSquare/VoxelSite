...
`);q=S.pop();for(let H of S)de(H)}if(q.trim()&&de(q),!u){let Q=b;Q?(o("Waiting for server to finish..."),await gr(Q,{onDone:l,onError:p,onFile:r,onStatus:o})):(h>0||g>0)&&l({files_modified:[],message:"",soft_close:!0})}}catch(x){if(x.name==="AbortError"){l({cancelled:!0,message:"Generation stopped."});return}if(u)return;if(h>0||g>0){let C=b;C?(o("Server is still generating \u2014 waiting for completion..."),await gr(C,{onDone:l,onError:p,onFile:r,onStatus:o})):l({files_modified:[],message:"",soft_close:!0})}else p({code:"stream_error",message:"Could not connect to the AI. Check your internet connection and API key, then try again."})}}async function gr(e,{onDone:t,onError:s,onFile:n,onStatus:o}){var r;let a=0;for(let l=0;l<120;l++){await new Promise(d=>setTimeout(d,3e3));try{let{ok:d,data:v}=await $.get(`/ai/conversations/${e}`);if(!d||!((r=v==null?void 0:v.conversation)!=null&&r.prompts))continue;let p=v.conversation.prompts,c=p[p.length-1];if(!c)continue;let m=c.files_modified?JSON.parse(c.files_modified):[];if(m.length>a){for(let f=a;f<m.length;f++)n({path:m[f],action:"write"});a=m.length}if(c.status==="streaming"){let f=Math.round((Date.now()-new Date(c.created_at).getTime())/1e3);o(`Server is still generating... (${f}s)`);continue}c.status==="success"?t({message:c.ai_message||"",files_modified:m,revision_id:c.revision_id||null,polled:!0}):c.status==="partial"?t({message:c.ai_message||"",files_modified:m,partial:!0,polled:!0}):s({code:"generation_failed",message:c.error_message||"Generation failed on the server."});return}catch{}}t({files_modified:[],message:"",partial:!0,soft_close:!0})}function hr(){return R.get("sessionToken")}var _c="data-theme",ea="dark";function br(){let e=R.get("theme")||localStorage.getItem("vs-theme")||ea;return yr(e),e}function yr(e){let t=e||ea;return document.documentElement.setAttribute(_c,t),localStorage.setItem("vs-theme",t),R.set("theme",t),t}function Go(){let e=R.get("theme")||ea;return yr(e==="dark"?"light":"dark")}var xr=typeof document<"u"?document.createElement("span"):null;function y(e){return e?(xr.textContent=e,xr.innerHTML):""}function ge(e){return e?String(e).replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):""}var Ac={".php":"php",".css":"css",".json":"json",".js":"javascript",".html":"html",".htm":"html",".md":"markdown",".xml":"xml",".svg":"xml",".txt":"plaintext"};function jn(e=""){let t=String(e||"").toLowerCase();for(let[s,n]of Object.entries(Ac))if(t.endsWith(s))return n;return"plaintext"}function ta(e){if(e===0)return"0 B";let t=1024,s=["B","KB","MB","GB"],n=Math.floor(Math.log(e)/Math.log(t));return parseFloat((e/Math.pow(t,n)).toFixed(1))+" "+s[n]}function On(e){let t=new Date(e),n=new Date-t,o=Math.floor(n/1e3),i=Math.floor(o/60),a=Math.floor(i/60),r=Math.floor(a/24);return o<60?"Just now":i<60?`${i} min${i!==1?"s":""} ago`:a<24?`${a} hour${a!==1?"s":""} ago`:r===1?"Yesterday":r<30?`${r} days ago`:t.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function qn(e){if(!e)return"";let t=Date.now(),s=new Date(e).getTime(),n=t-s,o=Math.floor(n/6e4),i=Math.floor(n/36e5),a=Math.floor(n/864e5);return o<1?"Just now":o<60?`${o} min ago`:i<24?`${i} hr ago`:a<7?`${a} day${a>1?"s":""} ago`:new Date(e).toLocaleDateString()}function Fn(e=16){let t="abcdefghijkmnpqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ23456789!@#$%",s=new Uint8Array(e);return crypto.getRandomValues(s),Array.from(s,n=>t[n%t.length]).join("")}function zn(e,t=40){if(!e)return"";let s=e.replace(/^https?:\/\//,"").replace(/^www\./,"").replace(/\/+$/,"");return s.length>t&&(s=s.substring(0,t-1)+"\u2026"),s}function ke(e){e.classList.remove("is-visible"),setTimeout(()=>e.remove(),350)}function Ee(e,t){let s=null;e.addEventListener("mousedown",n=>{s=n.target}),e.addEventListener("click",n=>{n.target===e&&s===e&&t(n)})}function Le({title:e="Confirm Action",description:t="Are you sure?",confirmLabel:s="Confirm",cancelLabel:n="Cancel",danger:o=!1}){return new Promise(i=>{var v,p;let a=document.getElementById("vs-confirm-overlay");a&&a.remove();let r=document.createElement("div");r.id="vs-confirm-overlay",r.className="vs-modal-overlay",r.innerHTML=`
  ...
  `,(l=r.querySelector(".vs-toast-action"))==null||l.addEventListener("click",v=>{v.stopPropagation(),s(),Un(r)}),(d=r.querySelector(".vs-toast-dismiss"))==null||d.addEventListener("click",v=>{v.stopPropagation(),Un(r)}),o.appendChild(r),r._autoTimer=setTimeout(()=>Un(r),a)}var Wn=null;function Tr(){return`
...
`),p=[];for(let c=0;c<v.length;c++){let m=v[c],f=/<([a-z][a-z0-9]*)\b(?:[^<>"']|"[^"]*"|'[^']*')*(\/?)\s*>/gi,u;for(;(u=f.exec(m))!==null;){let g=u[1].toLowerCase(),b=u[2]==="/";d.has(g)||b||p.push({tag:g,line:c+1})}let h=/<\/([a-z][a-z0-9]*)\s*>/gi;for(;(u=h.exec(m))!==null;){let g=u[1].toLowerCase();if(d.has(g))continue;if(p.length===0)return{message:`Extra </${g}> \u2014 no matching opening tag`,line:c+1,tag:g};let b=p[p.length-1];if(b.tag!==g)return{message:`Misnested: </${g}> but <${b.tag}> is still open (line ${b.line})`,line:c+1,tag:g};p.pop()}}if(p.length>0){let c=p[p.length-1];return{message:`Unclosed <${c.tag}> (line ${c.line})`,line:c.line,tag:c.tag}}return null}function Zn(e,t){if(!Xs)return;let{container:s,monacoInstance:n,cleanupDrag:o}=Xs;if(fe({type:"vx-editor:end-source-edit",apply:!!e,html:e?t:void 0}),n)try{n.dispose()}catch{}o(),s.classList.remove("vx-source-visible"),setTimeout(()=>{s.remove(),Ge()},200),Xs=null}function tp(e){dt();let t=oi(e.tagName,e.classList),s=(e.text||"").substring(0,60),n=document.createElement("div");n.className="vx-modal-overlay",n.setAttribute("role","dialog"),n.setAttribute("aria-modal","true"),n.innerHTML=`
  ...
  `}function dp(){return`
    ...
    <div class="vx-modal-body"><div class="vx-img-grid" id="vx-img-grid"><div class="vx-img-loading">Loading assets\u2026</div></div></div></div>`,document.body.appendChild(s),requestAnimationFrame(()=>s.classList.add("vx-modal-visible")),Ge();let n=()=>{s.classList.remove("vx-modal-visible"),s.removeEventListener("keydown",o),setTimeout(()=>{s.remove(),Ge(),!t&&Qe&&rl(Qe)},200)},o=i=>{i.key==="Escape"&&(i.stopPropagation(),i.preventDefault(),n())};s.addEventListener("keydown",o),s.querySelector("[data-close]").addEventListener("click",n),Ee(s,n),s.tabIndex=-1,s.focus(),Sp(s)}async function Sp(e){let t=e.querySelector("#vx-img-grid");try{let s=await $.get("/assets");if(!s.ok){t.innerHTML=`<div class="vx-img-empty">
      ...
      </div>`;return}t.innerHTML=n.map(o=>{let i=o.thumbnail||o.path;return`<button class="vx-img-item" data-path="${o.path}"><img src="${i}" alt="" loading="lazy"><span class="vx-img-name">${(o.filename||o.path).split("/").pop()}</span></button>`}).join(""),t.querySelectorAll(".vx-img-item").forEach(o=>{o.addEventListener("click",async()=>{var d,v;let i=o.dataset.path,a=(Qe==null?void 0:Qe.src)||"",r=(at==null?void 0:at.sourceFile)||(Qe==null?void 0:Qe.filePath)||zt();await Ip({filePath:r,oldSrc:a,newSrc:i,alt:((v=(d=Qe==null?void 0:Qe.outerHTML)==null?void 0:d.match(/alt="([^"]*)"/))==null?void 0:v[1])||"",sourceAddress:at})&&fe({type:"vx-editor:swap-image",src:i}),eo(),e.classList.remove("vx-modal-visible"),setTimeout(()=>e.remove(),200)})})}catch{t.innerHTML=`<div class="vx-img-empty">
    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
    <p class="vx-img-empty-title">Failed to load assets</p>
    <p class="vx-img-empty-desc">Check the browser console for details.</p>
...
`||c==="\r"||c==="	"||c==="/")&&l++,d=v+9}else{if(l--,l===0){let c=p+r.length;t.push({start:o,end:c,content:e.substring(o,c)})}d=p+r.length}}}return t}function Rp(e,t,s,n){if(s===n)return e;let o=Math.min(s,n),i=Math.max(s,n),a=t[o],r=t[i];if(!a||!r||a.end>r.start)return null;let l=e.substring(0,a.start),d=e.substring(a.end,r.start),v=e.substring(r.end);return l+r.content+d+a.content+v}function ml(){let e=document.getElementById("btn-visual-editor");e&&(e.classList.toggle("vx-editor-active",it),e.title=it?"Exit visual editor (V)":"Enter visual editor (V)",e.setAttribute("aria-pressed",String(it))),document.body.classList.toggle("vx-editing",it)}function K(e,t=!1){if(typeof window.showToast=="function"){window.showToast(e,t?"error":"success",2e3);return}let s=document.getElementById("vx-save-indicator");s||(s=document.createElement("div"),s.id="vx-save-indicator",s.className="vx-save-indicator",document.body.appendChild(s)),s.textContent=e,s.classList.toggle("vx-save-error",t),s.classList.add("vx-save-visible"),clearTimeout(K._timer),K._timer=setTimeout(()=>s.classList.remove("vx-save-visible"),2e3)}function fe(e){let t=document.getElementById("preview-iframe");if(t!=null&&t.contentWindow)try{t.contentWindow.postMessage(e,"*")}catch{}}function zt(){return window.__vsCurrentPreviewPath||"index.php"}function ga(e){let t=document.getElementById("preview-iframe"),s=e.offsetWidth||300,n=e.offsetHeight||520,o=32,i=56;if(!t){e.style.left=`${Math.max(o,window.innerWidth-s-o)}px`,e.style.top=`${Math.min(Math.max(80,i),Math.max(i,window.innerHeight-n-o))}px`;return}let a=t.getBoundingClientRect(),r=a.right-s-o,l=Math.max(o,a.left+10),d=Math.max(o,window.innerWidth-s-o),v=Math.min(Math.max(r,l),d),p=Math.max(a.top+12,i),c=Math.max(i,window.innerHeight-n-o),m=Math.min(p,c);e.style.left=`${v}px`,e.style.top=`${m}px`,e.style.right="auto"}function Zr(e,t,s){let n=e.offsetWidth||380,o=e.offsetHeight||180,i=16,a=56,r=document.getElementById("preview-iframe");if(!r||!s){ga(e);return}let l=r.getBoundingClientRect(),d=l.top+s.top,v=l.top+s.top+s.height,c=l.left+s.left+s.width/2-n/2,m,f=d-o-4;f>=a?m=f:m=v+8;let u=Math.max(i,window.innerWidth-n-i),g=Math.min(Math.max(c,i),u),b=Math.max(a,window.innerHeight-o-i),k=Math.min(Math.max(m,a),b);e.style.left=`${g}px`,e.style.top=`${k}px`,e.style.right="auto"}function Dp(e){let t=(s,n)=>new RegExp(`^${n}-(white|black|transparent|[a-z]+-(50|100|200|300|400|500|600|700|800|900|950))$`).test(s);return e.some(s=>t(s,"bg"))?"bg":e.some(s=>t(s,"border"))?"border":(e.some(s=>t(s,"text")),"text")}function Lt(e){return(e||"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function tt(e){return(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function ve(e,t,s={}){var o,i;let n={opId:(e==null?void 0:e.id)||"unknown",type:(e==null?void 0:e.type)||"unknown",event:t,sourceKind:((o=e==null?void 0:e.address)==null?void 0:o.sourceKind)||"unknown",sourceFile:((i=e==null?void 0:e.address)==null?void 0:i.sourceFile)||(e==null?void 0:e.filePath)||"unknown",timestamp:Date.now(),...s};la.push(n),la.length>zc&&la.shift(),t==="failed"||t==="fallback"?console.warn(`[VX-OPS] ${t}:`,aa(e==null?void 0:e.type),n):console.debug(`[VX-OPS] ${t}:`,aa(e==null?void 0:e.type),n.sourceFile)}async function Hp(){var s;let e=Or();if(!e){K("Nothing to undo");return}let t=e.filePath;if(!t){K("Undo failed \u2014 no file path",!0);return}try{let n=await $.get(`/files/content?path=${encodeURIComponent(t)}`);if(!n.ok){K("Undo failed \u2014 cannot read file",!0);return}let o=Jo(e.inverseOp,n.data.content);if(!o.applied){console.warn("[VX History] Undo applyOp failed:",o.reason),K("Undo failed \u2014 source has changed",!0);return}let i=await $.put("/files/content",{path:t,content:o.content});if(!i.ok){K("Undo failed \u2014 save error",!0);return}qr(),ve(e.inverseOp,"persisted",{strategy:o.strategy,via:"undo"}),K("Undone"),gn+=2,fe({type:"vx-editor:replay-op",op:e.inverseOp}),(s=i.data)!=null&&s.tailwindCompiled&&setTimeout(()=>{let a=document.getElementById("preview-iframe");a!=null&&a.contentWindow&&a.contentWindow.postMessage("voxelsite:reload-css","*")},300)}catch(n){console.error("[VX History] Undo error:",n),K("Undo failed",!0)}}async function Np(){var s;let e=Fr();if(!e){K("Nothing to redo");return}let t=e.filePath;if(!t){K("Redo failed \u2014 no file path",!0);return}try{let n=await $.get(`/files/content?path=${encodeURIComponent(t)}`);if(!n.ok){K("Redo failed \u2014 cannot read file",!0);return}let o=Jo(e.forwardOp,n.data.content);if(!o.applied){console.warn("[VX History] Redo applyOp failed:",o.reason),K("Redo failed \u2014 source has changed",!0);return}let i=await $.put("/files/content",{path:t,content:o.content});if(!i.ok){K("Redo failed \u2014 save error",!0);return}zr(),ve(e.forwardOp,"persisted",{strategy:o.strategy,via:"redo"}),K("Redone"),gn+=2,fe({type:"vx-editor:replay-op",op:e.forwardOp}),(s=i.data)!=null&&s.tailwindCompiled&&setTimeout(()=>{let a=document.getElementById("preview-iframe");a!=null&&a.contentWindow&&a.contentWindow.postMessage("voxelsite:reload-css","*")},300)}catch(n){console.error("[VX History] Redo error:",n),K("Redo failed",!0)}}function xl(){return setTimeout(()=>Es(),0),`
  ...
  `}async function Es(){var N,S,H,F,V,se,te;let e=document.getElementById("settings-content");if(!e)return;let[t,s,n,o,i,a,r]=await Promise.all([$.get("/settings"),$.get("/settings/system"),$.get("/settings/mail"),$.get("/settings/usage"),$.get("/files/content?path="+encodeURIComponent("assets/data/memory.json")),$.get("/files/content?path="+encodeURIComponent("assets/data/design-intelligence.json")),$.get("/settings/logs")]),l=((N=r.data)==null?void 0:N.logs)||[],d=((S=t.data)==null?void 0:S.settings)||{},v=((H=s.data)==null?void 0:H.system)||{},p=d.site_favicon||null,c=p?`/${p}?v=${Date.now()}`:"/favicon.ico?v="+Date.now(),m=null,f=null;try{i.ok&&((F=i.data)!=null&&F.content)&&(m=JSON.parse(i.data.content))}catch{}try{a.ok&&((V=a.data)!=null&&V.content)&&(f=JSON.parse(a.data.content))}catch{}let u=m||f,h=o.data||{models:[],totals:{request_count:0,total_input_tokens:0,total_output_tokens:0}},g=d.available_providers||{},b=((se=n.data)==null?void 0:se.config)||{},k=((te=n.data)==null?void 0:te.presets)||{},w=Object.keys(g),x=d.ai_provider||"claude",_=(g[x]||{name:"Claude",models:[],config_fields:[]}).config_fields||[],P=d[`ai_${x}_model`]||"",j=d[`ai_${x}_api_key_set`]||!1,Z=w.map(O=>{let ie=g[O];return`<option value="${y(O)}" ${O===x?"selected":""}>${y(ie.name)}</option>`}).join(""),Y="";for(let O of _)O.key==="api_key"?Y+=`
    ...
    <div class="vs-settings-card">
      ...
      <div class="vs-sys-grid">
        ${wt("VoxelSite",v.version||"1.0.0")}
        ${wt("PHP",v.php_version||"?")}
        ${wt("SQLite",v.sqlite_version||"?")}
        ${wt("Database",wa(v.database_size))}
        ${wt("Preview Files",wa(v.preview_size))}
        ${wt("Assets",wa(v.assets_size))}
        ${wt("Upload Limit",v.max_upload||"?")}
        ${wt("Memory Limit",v.memory_limit||"?")}
      </div>
    </div>
...
A page reload is required after the update completes.`)){t.classList.add("hidden"),n.classList.add("hidden"),s.classList.remove("hidden"),i.textContent=`Uploading ${c.name}...`;try{let g=new FormData;g.append("update_zip",c);let b=R.get("sessionToken"),k=await fetch("/_studio/api/router.php?_path=%2Fupdate%2Fupload",{method:"POST",credentials:"same-origin",headers:b?{"X-VS-Token":b}:{},body:g}),w=k.headers.get("content-type")||"",x;if(!w.includes("application/json")){let P=await k.text();if(P.includes("POST Content-Length")||P.includes("upload_max_filesize")||P.includes("exceeds")){v("Server Upload Limit Exceeded",`The file (${(c.size/1024/1024).toFixed(1)} MB) exceeds your server's PHP upload limit. Increase <code>upload_max_filesize</code> and <code>post_max_size</code> in php.ini, then restart your web server.`);return}v("Upload Failed","The server returned an unexpected response. Check your PHP error log for details.");return}x=await k.json(),s.classList.add("hidden"),n.classList.remove("hidden");let C=document.getElementById("vs-update-result-icon"),_=document.getElementById("vs-update-result-message");if(x.ok){let P=x.data;C.innerHTML='<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="var(--vs-success)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>',_.innerHTML=`
  ...
  `,document.body.appendChild(i),requestAnimationFrame(()=>i.classList.add("is-visible"));let a=()=>{i.classList.remove("is-visible"),setTimeout(()=>i.remove(),300),document.removeEventListener("keydown",r)},r=p=>{p.key==="Escape"&&a()};document.addEventListener("keydown",r),(d=i.querySelector("#vs-knowledge-close"))==null||d.addEventListener("click",a),(v=i.querySelector("#vs-knowledge-done"))==null||v.addEventListener("click",a),Ee(i,a)}function Vp(){let e=document.getElementById("btn-reset-site");e&&e.addEventListener("click",()=>{var t;(t=window.demoGuard)!=null&&t.call(window)||Kp()})}function Wp(){let e=document.getElementById("btn-reset-install");e&&e.addEventListener("click",()=>{var t;(t=window.demoGuard)!=null&&t.call(window)||Gp()})}function Gp(){let e=document.getElementById("reset-install-modal-overlay");e&&e.remove();let t=document.createElement("div");t.id="reset-install-modal-overlay",t.className="vs-modal-overlay",t.innerHTML=`
...
`;window.location.hash="#/chat",setTimeout(()=>{let i=document.getElementById("prompt-input");i&&(i.value=o,i.focus(),i.style.height="auto",i.style.height=i.scrollHeight+"px")},150)}async function Xl(e){if(po()||vo())return;await en();let t,s,n;e?(t=e.title||"",s=e.body||"",n=e.id):({title:t,body:s}=Ra(),n=De);let{ok:o,error:i}=await $.post("/cards",{title:t||"Untitled",body:s,column_name:"todo",source_note_id:n});o?I("Card added to Board.","success"):I((i==null?void 0:i.message)||"Failed to add card.","error")}function Bv(e,t){var a;(a=document.getElementById("vs-note-ctx"))==null||a.remove();let s=He.find(r=>r.id===t);if(!s)return;let n=s.pinned==1,o=document.createElement("div");o.id="vs-note-ctx",o.className="vs-note-context-menu",o.style.left=`${e.clientX}px`,o.style.top=`${e.clientY}px`,o.innerHTML=`
  ...
  `}function _d(e,t){if(!e||e.length===0)return"";let s=Ms.toLowerCase(),n="",o=2;for(let i of e){if(s&&!Cn(i,s))continue;let a=Mi()===i.id,r=ht.has(i.id),l=i.children.length>0,d=Math.min(t,o),v=t>o,p=d*20;n+=`
    ...
    `}return n}function eu(){if(!oe)return"";let e=Ms.toLowerCase(),t=new Map,s=Td.filter(o=>o.key!=="page");for(let o of s)t.set(o.key,[]);for(let[,o]of oe.nodes){let i=t.get(o.type);i&&i.push(o)}let n="";for(let o of s){let i=t.get(o.key)||[],a=e?i.filter(d=>{let v=(d.label||"").toLowerCase(),p=d.id.toLowerCase();return v.includes(e)||p.includes(e)}):i;a.sort((d,v)=>(d.label||d.id).localeCompare(v.label||v.id));let r=Rs.has(o.key),l=e?`${a.length}/${i.length}`:`${i.length}`;n+=`
  ...
  `}function Ln(e){let t=document.getElementById("vs-site-diagram");if(!t||!e||e.length===0)return;let s=t.querySelector(".vs-sc-connectors");s&&s.remove();let n=[],o=x=>{for(let C of x)if(C.children.length>0&&!ht.has(C.id)){for(let _ of C.children)n.push({parentId:C.id,childId:_.id});o(C.children)}},i=Ms.toLowerCase(),a=x=>{if(!i)return x;let C=[];for(let _ of x)if(Cn(_,i)){let P=a(_.children);C.push({..._,children:P})}return C},r=a(e),l=r.find(x=>x.isHomepage),d=r.filter(x=>!x.isHomepage);if(l)for(let x of d)n.push({parentId:l.id,childId:x.id});if(o(r),n.length===0)return;let v=t.getBoundingClientRect(),p=t.scrollLeft,c=t.scrollTop,m=[];for(let{parentId:x,childId:C}of n){let _=t.querySelector(`.vs-site-card[data-page-id="${CSS.escape(x)}"]`),P=t.querySelector(`.vs-site-card[data-page-id="${CSS.escape(C)}"]`);if(!_||!P)continue;let j=_.getBoundingClientRect(),Z=P.getBoundingClientRect(),Y=j.left-v.left+p+j.width/2,q=j.top-v.top+c+j.height,de=Z.left-v.left+p+Z.width/2,Q=Z.top-v.top+c,N=q+(Q-q)/2,S=`M ${Y} ${q} V ${N} H ${de} V ${Q}`,H=pe&&(x===pe||C===pe);m.push({d:S,isActive:H})}if(m.length===0)return;let f=t.scrollWidth,u=t.scrollHeight,h=document.createElementNS("http://www.w3.org/2000/svg","svg");h.setAttribute("class","vs-sc-connectors"),h.setAttribute("width",f),h.setAttribute("height",u),h.setAttribute("viewBox",`0 0 ${f} ${u}`),h.setAttribute("aria-hidden","true");let g=document.createElementNS("http://www.w3.org/2000/svg","g");g.setAttribute("class","vs-sc-hierarchy-rails");let b=m.filter(x=>!x.isActive),k=m.filter(x=>x.isActive);for(let{d:x}of b){let C=document.createElementNS("http://www.w3.org/2000/svg","path");C.setAttribute("d",x),g.appendChild(C)}for(let{d:x}of k){let C=document.createElementNS("http://www.w3.org/2000/svg","path");C.setAttribute("d",x),C.classList.add("active"),g.appendChild(C)}h.appendChild(g);let w=document.createElementNS("http://www.w3.org/2000/svg","g");w.setAttribute("class","vs-sc-impact-overlays"),h.appendChild(w),t.appendChild(h)}function Pd(e){if(!e||e.length===0)return'<div class="vs-site-diagram-empty">No pages found</div>';let t=Ms.toLowerCase(),s=v=>{if(!t)return v;let p=[];for(let c of v)if(Cn(c,t)){let m=s(c.children);p.push({...c,children:m})}return p},n=v=>{let p=[];for(let c of v.children)p.push(c),c.children.length>0&&!ht.has(c.id)&&p.push(...o(c));return p},o=v=>{let p=[];for(let c of v.children)p.push(c),c.children.length>0&&!ht.has(c.id)&&p.push(...o(c));return p},i=s(e),a=i.find(v=>v.isHomepage),r=i.filter(v=>!v.isHomepage),l=v=>{if(v.children.length===0||ht.has(v.id))return"";let p=t?v.children.filter(m=>Cn(m,t)):v.children;if(p.length===0)return"";let c=`<div class="vs-site-tier-group" data-parent-id="${y(v.id)}">`;c+=`<div class="vs-site-tier-group-label"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z"/></svg>${y(v.label)}</div>`,c+='<div class="vs-site-tier-group-cards">';for(let m of p)if(c+=Ii(m),m.children.length>0&&!ht.has(m.id)){let f=n(m),u=t?f.filter(h=>h.label.toLowerCase().includes(t)||h.slug.toLowerCase().includes(t)):f;if(u.length>0){c+='<div class="vs-site-tier-l3-inline">';for(let h of u)c+=Ii(h);c+="</div>"}}return c+="</div></div>",c},d='<div class="vs-site-tiers">';if(a&&(d+=`
      <div class="vs-site-tier vs-site-tier-home">
        ${Ii(a)}
      </div>
    `),r.length>0||a&&a.children.length>0&&!ht.has(a.id)){if(d+='<div class="vs-site-tier vs-site-tier-l1">',a&&a.children.length>0&&!ht.has(a.id)){let v=l(a);v&&(d+=`<div class="vs-site-tier-column">${v}</div>`)}for(let v of r)d+='<div class="vs-site-tier-column">',d+=Ii(v),d+=l(v),d+="</div>";d+="</div>"}return d+="</div>",d}function Ii(e){let t=Mi()===e.id,s=e.hierarchySource==="inferred",n=on(e.id),o="";if(n){let a=oe.nodes.get(n);a&&(o=a.label||a.id.replace("route:",""))}else e.isHomepage?o="/ \xB7 Homepage":e.slug&&(o="/"+e.slug);return`
  ...
  `}function pu(){var e,t,s,n,o,i,a;if(ye==="plan"&&Ue){let r=Ue.files||[],l=Ue.affected_pages||[],d=Ue.skipped||[],v=Ue.intent||null,p=Ue.edits||[],c=Ue.risk_level||"medium",m=Ue.plan_summary||"",f=p.filter(g=>g.anchored!==!1),u=p.filter(g=>g.anchored===!1),h=f.length>0;return`
    ...
    `}if(ye==="plan_failed"&&Ue){let r=Ue.files||[],l=Ue.affected_pages||[],d=Ue.edits||[],v=Ue.plan_summary||"",p=d.filter(c=>!c.anchored);return`
      <div class="vs-sc-orch-review">
        <div class="vs-sc-review-section">
    ...
    `;if(ye==="applied"){let r=((e=Kt)==null?void 0:e.filesChanged)||0,l=((t=Kt)==null?void 0:t.verification)||[],d=(s=Kt)==null?void 0:s.duration_ms,v=0,p=0;l.forEach(m=>{m.checks.forEach(f=>{v++,f.passed&&p++})});let c=l.map(m=>{let f=m.checks.map(u=>{let h=u.passed?"\u2714":"\u2717";return`<div class="vs-sc-verify-check ${u.passed?"is-passed":"is-failed"}">
    ...
    `}if(ye==="apply_failed"){let r=((n=Kt)==null?void 0:n.summary)||"Patch execution failed.",l=((o=Kt)==null?void 0:o.rollback_clean)!==!1,d=((i=Kt)==null?void 0:i.verification)||[],v=(a=Kt)==null?void 0:a.duration_ms,p=l?"All changes have been rolled back. No files were modified.":"Rollback was attempted but may not have fully succeeded. Check the console log.",c=l?"is-clean":"is-dirty",m=d.map(f=>{let u=f.checks.map(h=>{let g=h.passed?"\u2714":"\u2717";return`<div class="vs-sc-verify-check ${h.passed?"is-passed":"is-failed"}">
  ...
  `}function qd(e,t){var i;let s=(i=oe)==null?void 0:i.nodes.get(e);if(!s)return;As(),vs(),us(),ye!=="idle"&&(Ye("idle"),ct(null),Gt(null));let n=e;if(s.type==="page"&&(n=on(e),!n)||s.type!=="page"&&s.type!=="route")return;tn(n),sn(e),Bs(""),xi(!0),$e("idle"),st(null),Tt(null);let o=oe.edgesByTarget.get(n)||[];for(let a of o)if(a.type==="links_to"){let r=oe.nodes.get(a.source);(r==null?void 0:r.type)==="partial"&&!Xe.has(a.source)&&uu(a.source,t)}}function Ns(){tn(null),sn(null),Bs(""),$e("idle"),st(null),Tt(null)}function Fd(e){var s;let t=(s=oe)==null?void 0:s.nodes.get(e);!t||t.type!=="page"||(As(),Ns(),us(),ye!=="idle"&&(Ye("idle"),ct(null),Gt(null)),vs(),cd(!0),$i(!0),$e("idle"),st(null),Tt(null))}function Lo(){vs(),$e("idle"),st(null),Tt(null)}function zd(e){var s;let t=(s=oe)==null?void 0:s.nodes.get(e);!t||t.type!=="page"||(Ns(),vs(),us(),ye!=="idle"&&(Ye("idle"),ct(null),Gt(null)),As(),bd(!0),yd(t.label||""))}function Tn(){As()}function Ud(e){var s,n;let t=(s=oe)==null?void 0:s.nodes.get(e);!t||t.type!=="page"||(n=t.meta)!=null&&n.isHomepage||(Ns(),vs(),As(),ye!=="idle"&&(Ye("idle"),ct(null),Gt(null)),us(),wd(!0))}function _i(){us()}async function uu(e,t){if(Xe.has(e))return;let{ok:s,data:n}=await $.get("/site-graph/blast-radius?node="+encodeURIComponent(e));s&&n&&!Xe.has(e)&&(Xe.set(e,n),t&&t())}function mu(){var p;let e=(p=oe)==null?void 0:p.nodes.get(Ht);if(!e)return Ns(),pe?Ja():Sn();let t=e.label||e.id,s=t==="/"||e.id==="route:/";if(ze==="success"&&Ke)return`
    ...
    `}else!s&&i.length===0&&Is&&(v='<div class="vs-sc-form-hint">No references to update.</div>');return`
    <div class="vs-sc-form">
      <h3 class="vs-sc-form-section">Change URL</h3>
  ...
  `}function ku(e){var v,p,c,m,f;if(rt===void 0||!kt)return"";let t=(v=e.meta)!=null&&v.isHomepage?"/":"/"+(((p=e.meta)==null?void 0:p.slug)||""),s=e.label||((c=e.meta)==null?void 0:c.slug)||"",n=[];if(rt===null)n=kt.filter(u=>u.href!==t);else for(let u of kt)if(u.href===rt){n=(u.children||[]).filter(h=>h.href!==t);break}if(n.length===0)return`
      <div class="vs-sc-form-field">
  ...
  `}function Cu(){var v,p;let e=(v=oe)==null?void 0:v.nodes.get(pe);if(!e)return Sn();let t=y(e.label||""),s=e.id.replace("page:","");if(ft==="success"&&Eo){let c=Eo;return`
      <div class="vs-sc-form">
  ...
  `}function So(e){Ht&&(tn(null),sn(null),Bs(""),$e("idle"),st(null),Tt(null)),nn&&(vs(),$e("idle"),st(null),Tt(null)),_s&&Tn(),Ps&&_i(),Vt(e),Si(e),e&&e.startsWith("page:")&&ds(e),e&&Mn(e),X()}function To(){tn(null),sn(null),Bs(""),$e("idle"),st(null),Tt(null),nn&&vs(),_s&&As(),Ps&&us(),Vt(null),Si(null),X()}async function Mn(e){if(Xe.has(e))return;yi(e),X();let{ok:t,data:s}=await $.get("/site-graph/blast-radius?node="+encodeURIComponent(e));ho===e&&(yi(null),t&&s&&Xe.set(e,s),X())}async function Su(){var a,r,l,d;if((a=window.demoGuard)!=null&&a.call(window)||!Ht||!Is)return;let e=(r=oe)==null?void 0:r.nodes.get(Ht),t=(e==null?void 0:e.label)||(e==null?void 0:e.id)||"",s=Za(Is,t);if(!s.valid){$e("idle"),X();return}$e("applying"),st(null),X();let{ok:n,data:o,error:i}=await $.post("/site-control/url-rename",{routeId:Ht,newPath:s.cleanPath});if(n&&o){$e("success"),Tt(o),dd(o.suggestedPrompt||null),o.newPageId&&(Vt(o.newPageId),ds(o.newPageId));let v=await $.get("/site-graph");if(v.ok&&v.data&&(Ts(Ds(v.data)),Xe.clear(),ps(ms())),o.newPageId&&Mn(o.newPageId),o.oldPath&&o.newPath){let p=o.oldPath.replace(/^\//,"")+".php",c=o.newPath.replace(/^\//,"")+".php";(d=(l=window.__vsEditorPage)==null?void 0:l.reconcileMove)==null||d.call(l,p,c)}X(),setTimeout(()=>{Ns(),X()},1500)}else $e("error"),st(i||{message:"An unknown error occurred."}),X()}async function Tu(e){Fd(e),X();let{ok:t,data:s}=await $.get("/site-control/nav-preflight?pageId="+encodeURIComponent(e));if($i(!1),!t||!s){za("nav_parse_error"),X();return}za(s.navStatus||null),fd(s.isInNav||!1),hd(s.isHomepage||!1),vd(s.currentPosition||null),ud(s.navTree||null),gd(s.hasHomeEntry||!1),pd(s.navStatus==="needs_normalization"),s.currentPosition&&(Fa(s.currentPosition.parentHref??null),bo(s.currentPosition.index??0)),X()}async function Mu(){var s,n,o,i,a,r,l,d,v;if((s=window.demoGuard)!=null&&s.call(window)||!pe||Wt===null)return;let e=((n=Nt)==null?void 0:n.parentHref)??null,t=rt!==e;if($e("applying"),st(null),X(),t){let p=rt?rt.replace(/^\//,""):"",{ok:c,data:m,error:f}=await $.post("/site-control/structural-move",{pageId:pe,targetParent:p});if(c&&m){if($e("success"),Tt(m),((o=m.movedPages)==null?void 0:o.length)>0&&window.__vsEditorPage)for(let w of m.movedPages)(a=(i=window.__vsEditorPage).reconcileMove)==null||a.call(i,w.oldFilePath,w.newFilePath);let u=await $.get("/site-graph");u.ok&&u.data&&(Ts(Ds(u.data)),Xe.clear(),ps(ms()));let h=pe;((r=m.movedPages)==null?void 0:r.length)>0&&(h="page:"+m.movedPages[0].newFilePath,Vt(h),ds(h),Mn(h));let g=await $.post("/site-control/nav-reorder",{pageId:h,targetParentHref:rt,targetIndex:Wt});if(!g.ok&&((l=g.error)==null?void 0:l.code)!=="no_change"&&((d=g.error)==null?void 0:d.code)!=="page_not_in_nav"){$e("error"),st({message:"Page moved successfully, but could not set the requested position: "+(((v=g.error)==null?void 0:v.message)||"Unknown error")}),X();return}let k=await $.get("/site-graph");k.ok&&k.data&&(Ts(Ds(k.data)),Xe.clear(),ps(ms())),X(),setTimeout(()=>{Lo(),X()},1500)}else $e("error"),st(f||{message:"An unknown error occurred."}),X()}else{let p={pageId:pe,targetParentHref:rt,targetIndex:Wt},{ok:c,data:m,error:f}=await $.post("/site-control/nav-reorder",p);if(c&&m){$e("success"),Tt(m);let u=pe;Vt(u),ds(u);let h=await $.get("/site-graph");h.ok&&h.data&&(Ts(Ds(h.data)),Xe.clear(),ps(ms())),Mn(u),X(),setTimeout(()=>{Lo(),X()},1500)}else $e("error"),st(f||{message:"An unknown error occurred."}),X()}}async function Vd(e){var i;if((i=window.demoGuard)!=null&&i.call(window)||!pe||!e)return;Li("applying"),Ua(null),X();let t={pageId:pe,newTitle:e},{ok:s,data:n,error:o}=await $.post("/site-control/page-rename",t);if(s&&n){Li("success"),xd(n);let a=pe;Vt(a),ds(a);let r=await $.get("/site-graph");r.ok&&r.data&&(Ts(Ds(r.data)),Xe.clear(),ps(ms())),Mn(a),X(),setTimeout(()=>{Tn(),X()},1500)}else Li("error"),Ua((o==null?void 0:o.message)||"An unknown error occurred."),X()}async function Iu(){var n;if((n=window.demoGuard)!=null&&n.call(window)||!pe)return;jt("applying"),Va(null),X();let{ok:e,data:t,error:s}=await $.post("/site-control/page-delete",{pageId:pe});e&&t?(jt("success"),kd(t),X(),setTimeout(async()=>{var a,r,l;let o=(a=t.deletedPage)==null?void 0:a.filePath;o&&((l=(r=window.__vsEditorPage)==null?void 0:r.reconcileDelete)==null||l.call(r,o)),Vt(null),ds(null);let i=await $.get("/site-graph");i.ok&&i.data&&(Ts(Ds(i.data)),Xe.clear(),ps(ms())),us(),X()},1800)):(jt("error"),Va((s==null?void 0:s.message)||"An unknown error occurred."),X())}function Bu(e){let t=document.querySelector(`.vs-site-tree-group[data-tree-group="${e}"]`);ht.has(e)?(ht.delete(e),t&&t.classList.remove("is-collapsed")):(ht.add(e),t&&t.classList.add("is-collapsed"))}function X(){var l,d,v;let e=document.getElementById("vs-site-root");if(!e)return;let t=((l=document.activeElement)==null?void 0:l.id)==="vs-proposal-url",s=t?document.activeElement.selectionStart:null,n=((d=document.activeElement)==null?void 0:d.id)==="vs-sc-rename-input",o=n?document.activeElement.value:null,i=n?document.activeElement.selectionStart:null,a=((v=document.activeElement)==null?void 0:v.id)==="vs-sc-search",r=a?document.activeElement.selectionStart:null;if(Kd(e),t){let p=document.getElementById("vs-proposal-url");p&&(p.focus(),s!==null&&p.setSelectionRange(s,s))}if(n){let p=document.getElementById("vs-sc-rename-input");p&&(p.value=o,p.focus(),i!==null&&p.setSelectionRange(i,i))}if(a){let p=document.getElementById("vs-sc-search");p&&(p.focus(),r!==null&&p.setSelectionRange(r,r))}}async function Wd(e){Ye("running"),Bi(e),Xa(),ct(null),Gt(null),X(),setTimeout(()=>{var t;return(t=document.getElementById("vs-sc-composer-input"))==null?void 0:t.focus()},0);try{await Ft("/site-control/orchestrate",{prompt:e},{onStatus(t){an({type:"info",message:t.message||"Processing\u2026",time:Date.now()}),Xd()},onDone(t){if(ye==="running"){an({type:"done",message:t.summary||t.message||"Done.",time:Date.now()});let s=t.discovery||null,n=t.intent||null,o=t.plan||null,i=s&&Array.isArray(s.candidates)&&s.candidates.length>0,a=o&&Array.isArray(o.edits)?o.edits:[],l=a.filter(d=>d.anchored!==!1).length>0;i?(Gt({intent:n,files:s.candidates.map(d=>({type:d.type||"file",path:d.file||d.node_id,label:d.label||"",reason:d.reason||""})),affected_pages:(s.affected_pages||[]).map(d=>({label:d.label||"",slug:d.slug||""})),skipped:(s.skipped||[]).map(d=>({path:d.path||"",reason:d.reason||""})),edits:a,risk_level:(o==null?void 0:o.risk_level)||"medium",plan_summary:(o==null?void 0:o.summary)||"",anchored_count:(o==null?void 0:o.anchored_count)||0,unanchored_count:(o==null?void 0:o.unanchored_count)||0}),l?Ye("plan"):Ye("plan_failed")):Ye("complete"),ct({filesChanged:t.filesChanged||0,summary:t.summary||t.message||"Orchestration complete."}),X()}},onError(t){Ye("complete"),ct({filesChanged:0,summary:t.message||"Orchestration failed."}),an({type:"error",message:t.message||"Error during orchestration.",time:Date.now()}),X()}})}catch{Ye("complete"),ct({filesChanged:0,summary:"Connection error."}),an({type:"error",message:"Connection lost during orchestration.",time:Date.now()}),X()}}async function _u(){if(!Ue||!Ue.edits)return;let e=Ue.edits.filter(t=>t.anchored!==!1);if(e.length!==0){Ye("applying"),X();try{await Ft("/site-control/apply",{edits:e},{onStatus(t){an({phase:t.phase||"status",status:t.status||"ok",file:t.file||"",message:t.message||"",bytes:t.bytes||null,ms:t.ms||null,time:Date.now()}),Xd()},onDone(t){let s=t.filesChanged||0;Ye("applied"),ct({filesChanged:s,summary:t.message||"Done.",verification:t.verification||[],duration_ms:t.duration_ms||null}),X(),Qa()},onError(t){Ye("apply_failed"),ct({filesChanged:0,summary:t.message||"Patch execution failed.",rollback_clean:t.rollback_clean!==!1,verification:t.verification||[],duration_ms:t.duration_ms||null}),X()}})}catch{Ye("apply_failed"),ct({filesChanged:0,summary:"Connection error during apply."}),an({phase:"failed",status:"error",message:"Connection lost during apply.",time:Date.now()}),X()}}}var Au={start:"\u25B6",snapshot:"\u25CE",read:"\u2193",anchor:"\u2693",patch:"\u270E",lint:"\u2318",verify:"\u2714",reject:"\u2298",rollback:"\u21BA",done:"\u2713",failed:"\u2717",abort:"\u2298"},Pu={ok:"is-ok",failed:"is-failed",error:"is-failed",skip:"is-skip",refused:"is-refused",start:"is-info",partial:"is-warning"};function Xd(){let e=document.getElementById("vs-sc-console-log");if(!e)return;let t=Hs.map(s=>{if(s.phase){let i=Au[s.phase]||"\xB7",a=Pu[s.status]||"",r=s.file?`<span class="vs-sc-log-file">${s.file.replace(/&/g,"&amp;").replace(/</g,"&lt;")}</span> `:"",l=s.ms!=null?`<span class="vs-sc-log-meta">${s.ms}ms</span>`:s.bytes!=null?`<span class="vs-sc-log-meta">${s.bytes}b</span>`:"",d=(s.message||"").replace(/&/g,"&amp;").replace(/</g,"&lt;");return`<div class="vs-sc-log-entry vs-sc-log-phase ${a}">
    ...
    ${Bl()}
    ${Sm()}
  `,Bm(),xm(),e==="editor"&&!s&&!o&&Mr()}function om(){let e=R.get("route"),t=R.get("user"),s=R.get("theme"),n=t==null?void 0:t.role,o=Vi(e),i=Do.filter(l=>l.routes.some(d=>!d.roles||d.roles.includes(n))).map(l=>{let d=l.id===o,v=Ku(l);return`
  ...
  `}function vm(){let e=document.getElementById("btn-save-profile"),t=document.getElementById("profile-info-feedback");e&&e.addEventListener("click",async()=>{var d,v,p,c;let o=(v=(d=document.getElementById("profile-name"))==null?void 0:d.value)==null?void 0:v.trim(),i=(c=(p=document.getElementById("profile-email"))==null?void 0:p.value)==null?void 0:c.trim();if(!o||o.length<2){t&&(t.textContent="Name must be at least 2 characters.",t.className="text-sm text-vs-error");return}e.disabled=!0,e.textContent="Saving...";let{ok:a,error:r,data:l}=await $.put("/auth/profile",{name:o,email:i});e.disabled=!1,e.textContent="Save Profile",a&&(l!=null&&l.user)?(R.set("user",l.user),t&&(t.textContent="Profile updated.",t.className="text-sm text-vs-success"),setTimeout(()=>Ve(),800)):t&&(t.textContent=(r==null?void 0:r.message)||"Failed to update profile.",t.className="text-sm text-vs-error")});let s=document.getElementById("btn-save-password"),n=document.getElementById("profile-pw-feedback");s&&s.addEventListener("click",async()=>{var d,v,p;let o=((d=document.getElementById("profile-current-pw"))==null?void 0:d.value)||"",i=((v=document.getElementById("profile-new-pw"))==null?void 0:v.value)||"",a=((p=document.getElementById("profile-confirm-pw"))==null?void 0:p.value)||"";if(!o){n&&(n.textContent="Current password is required.",n.className="text-sm text-vs-error");return}if(i.length<8){n&&(n.textContent="New password must be at least 8 characters.",n.className="text-sm text-vs-error");return}if(i!==a){n&&(n.textContent="Passwords do not match.",n.className="text-sm text-vs-error");return}s.disabled=!0,s.textContent="Updating...";let{ok:r,error:l}=await $.put("/auth/password",{current_password:o,new_password:i});s.disabled=!1,s.textContent="Update Password",r?(document.getElementById("profile-current-pw").value="",document.getElementById("profile-new-pw").value="",document.getElementById("profile-confirm-pw").value="",n&&(n.textContent="Password updated.",n.className="text-sm text-vs-success")):n&&(n.textContent=(l==null?void 0:l.message)||"Failed to update password.",n.className="text-sm text-vs-error")})}function um(){let e=document.getElementById("conversation-history-panel");if(!e)return;e.classList.contains("hidden")?(e.classList.remove("hidden"),mm()):e.classList.add("hidden")}async function mm(){let e=document.getElementById("conversation-list");if(!e)return;e.innerHTML='<div class="px-4 py-3 text-xs text-vs-text-ghost text-center">Loading...</div>';let{ok:t,data:s,error:n}=await $.get("/ai/conversations");if(!t||!(s!=null&&s.conversations)){e.innerHTML=`<div class="px-4 py-3 text-xs text-vs-text-ghost text-center">${y((n==null?void 0:n.message)||"Could not load conversations.")}</div>`;return}let o=s.conversations,i=R.get("activeConversationId");if(o.length===0){e.innerHTML='<div class="px-4 py-3 text-xs text-vs-text-ghost text-center">No conversations yet. Start chatting!</div>';return}e.innerHTML=o.map(a=>{let r=a.id===i,l=a.title||"Untitled conversation",d=a.updated_at?new Date(a.updated_at).toLocaleDateString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"";return`
    ...
    `}).join(""),e.querySelectorAll("[data-conversation-id]").forEach(a=>{a.addEventListener("click",()=>{let r=a.dataset.conversationId;qi(r);let l=document.getElementById("conversation-history-panel");l&&l.classList.add("hidden")})})}async function qi(e){let t=document.getElementById("chat-messages");if(!t)return;t.innerHTML='<div class="flex items-center justify-center h-full text-sm text-vs-text-ghost">Loading conversation...</div>';let{ok:s,data:n,error:o}=await $.get(`/ai/conversations/${e}`);if(!s||!(n!=null&&n.conversation)){R.set("activeConversationId",null),zi(null);try{localStorage.removeItem("vs-active-conversation")}catch{}t.innerHTML=_n(),Bn();return}let i=n.conversation,a=i.prompts||[];R.set("activeConversationId",e),zi(i.page_scope||null);try{localStorage.setItem("vs-active-conversation",e)}catch{}if(a.length===0){t.innerHTML=_n(),Bn();return}let r="",l=!1;for(let d of a){let{text:v,images:p,webRefUrl:c}=Dm(d.user_prompt),m=p.length>0?`<div class="vs-msg-user-images">${p.map(u=>`<img src="${u}" class="vs-msg-user-image" />`).join("")}</div>`:"",f=c?`<div class="vs-msg-user-webref"><a href="${ge(c)}" target="_blank" rel="noopener" title="${ge(c)}">${E.globe} <span>${y(zn(c))}</span></a></div>`:"";if(r+=`
      <div class="mb-5">
  ...
  `,document.body.appendChild(t),requestAnimationFrame(()=>t.classList.add("is-visible"));let s=()=>ke(t);t.querySelector("#vs-pages-modal-close").addEventListener("click",s),Ee(t,s),t.addEventListener("keydown",v=>{v.key==="Escape"&&s()});let n=t.querySelector("#vs-pages-modal-body"),{ok:o,data:i,error:a}=await $.get("/pages?flat=1");if(!o||!Array.isArray(i==null?void 0:i.pages)){n.innerHTML=`
    ...
    `;return}let l='<div style="display: flex; flex-direction: column; gap: 2px;">';r.forEach(v=>{let p=!!Number(v.is_homepage),c=v.title||v.slug||v.path,m=v.path||v.slug+".php",f="/"+m.replace(/\.php$/,"").replace(/^index$/,""),u=f==="/"?"/":f,h=dm(v.slug),b=(window.__vsCurrentPreviewPath||"index.php")===m,k=v.size?(v.size/1024).toFixed(1)+" KB":"";l+=`
