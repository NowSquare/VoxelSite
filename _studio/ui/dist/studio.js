...
`||d==="\r"||d==="	"||d==="/")&&l++,c=u+9}else{if(l--,l===0){let d=p+r.length;t.push({start:o,end:d,content:e.substring(o,d)})}c=p+r.length}}}return t}function Yl(e,t,s,n){if(s===n)return e;let o=Math.min(s,n),i=Math.max(s,n),a=t[o],r=t[i];if(!a||!r||a.end>r.start)return null;let l=e.substring(0,a.start),c=e.substring(a.end,r.start),u=e.substring(r.end);return l+r.content+c+a.content+u}function xa(){let e=document.getElementById("btn-visual-editor");e&&(e.classList.toggle("vx-editor-active",Ke),e.title=Ke?"Exit visual editor (V)":"Enter visual editor (V)",e.setAttribute("aria-pressed",String(Ke))),document.body.classList.toggle("vx-editing",Ke)}function W(e,t=!1){if(typeof window.showToast=="function"){window.showToast(e,t?"error":"success",2e3);return}let s=document.getElementById("vx-save-indicator");s||(s=document.createElement("div"),s.id="vx-save-indicator",s.className="vx-save-indicator",document.body.appendChild(s)),s.textContent=e,s.classList.toggle("vx-save-error",t),s.classList.add("vx-save-visible"),clearTimeout(W._timer),W._timer=setTimeout(()=>s.classList.remove("vx-save-visible"),2e3)}function ue(e){let t=document.getElementById("preview-iframe");if(t!=null&&t.contentWindow)try{t.contentWindow.postMessage(e,"*")}catch{}}function yt(){return window.__vsCurrentPreviewPath||"index.php"}function No(e){let t=document.getElementById("preview-iframe"),s=e.offsetWidth||300,n=e.offsetHeight||520,o=32,i=56;if(!t){e.style.left=`${Math.max(o,window.innerWidth-s-o)}px`,e.style.top=`${Math.min(Math.max(80,i),Math.max(i,window.innerHeight-n-o))}px`;return}let a=t.getBoundingClientRect(),r=a.right-s-o,l=Math.max(o,a.left+10),c=Math.max(o,window.innerWidth-s-o),u=Math.min(Math.max(r,l),c),p=Math.max(a.top+12,i),d=Math.max(i,window.innerHeight-n-o),v=Math.min(p,d);e.style.left=`${u}px`,e.style.top=`${v}px`,e.style.right="auto"}function oa(e,t,s){let n=e.offsetWidth||380,o=e.offsetHeight||180,i=16,a=56,r=document.getElementById("preview-iframe");if(!r||!s){No(e);return}let l=r.getBoundingClientRect(),c=l.top+s.top,u=l.top+s.top+s.height,d=l.left+s.left+s.width/2-n/2,v,m=c-o-4;m>=a?v=m:v=u+8;let f=Math.max(i,window.innerWidth-n-i),h=Math.min(Math.max(d,i),f),g=Math.max(a,window.innerHeight-o-i),w=Math.min(Math.max(v,a),g);e.style.left=`${h}px`,e.style.top=`${w}px`,e.style.right="auto"}function Jl(e){let t=(s,n)=>new RegExp(`^${n}-(white|black|transparent|[a-z]+-(50|100|200|300|400|500|600|700|800|900|950))$`).test(s);return e.some(s=>t(s,"bg"))?"bg":e.some(s=>t(s,"border"))?"border":(e.some(s=>t(s,"text")),"text")}function dt(e){return(e||"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function Ve(e){return(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function de(e,t,s={}){var o,i;let n={opId:(e==null?void 0:e.id)||"unknown",type:(e==null?void 0:e.type)||"unknown",event:t,sourceKind:((o=e==null?void 0:e.address)==null?void 0:o.sourceKind)||"unknown",sourceFile:((i=e==null?void 0:e.address)==null?void 0:i.sourceFile)||(e==null?void 0:e.filePath)||"unknown",timestamp:Date.now(),...s};_o.push(n),_o.length>ol&&_o.shift(),t==="failed"||t==="fallback"?console.warn(`[VX-OPS] ${t}:`,Bo(e==null?void 0:e.type),n):console.debug(`[VX-OPS] ${t}:`,Bo(e==null?void 0:e.type),n.sourceFile)}async function Zl(){var s;let e=Wi();if(!e){W("Nothing to undo");return}let t=e.filePath;if(!t){W("Undo failed \u2014 no file path",!0);return}try{let n=await E.get(`/files/content?path=${encodeURIComponent(t)}`);if(!n.ok){W("Undo failed \u2014 cannot read file",!0);return}let o=An(e.inverseOp,n.data.content);if(!o.applied){console.warn("[VX History] Undo applyOp failed:",o.reason),W("Undo failed \u2014 source has changed",!0);return}let i=await E.put("/files/content",{path:t,content:o.content});if(!i.ok){W("Undo failed \u2014 save error",!0);return}Gi(),de(e.inverseOp,"persisted",{strategy:o.strategy,via:"undo"}),W("Undone"),ys+=2,ue({type:"vx-editor:replay-op",op:e.inverseOp}),(s=i.data)!=null&&s.tailwindCompiled&&setTimeout(()=>{let a=document.getElementById("preview-iframe");a!=null&&a.contentWindow&&a.contentWindow.postMessage("voxelsite:reload-css","*")},300)}catch(n){console.error("[VX History] Undo error:",n),W("Undo failed",!0)}}async function Ql(){var s;let e=Ki();if(!e){W("Nothing to redo");return}let t=e.filePath;if(!t){W("Redo failed \u2014 no file path",!0);return}try{let n=await E.get(`/files/content?path=${encodeURIComponent(t)}`);if(!n.ok){W("Redo failed \u2014 cannot read file",!0);return}let o=An(e.forwardOp,n.data.content);if(!o.applied){console.warn("[VX History] Redo applyOp failed:",o.reason),W("Redo failed \u2014 source has changed",!0);return}let i=await E.put("/files/content",{path:t,content:o.content});if(!i.ok){W("Redo failed \u2014 save error",!0);return}Xi(),de(e.forwardOp,"persisted",{strategy:o.strategy,via:"redo"}),W("Redone"),ys+=2,ue({type:"vx-editor:replay-op",op:e.forwardOp}),(s=i.data)!=null&&s.tailwindCompiled&&setTimeout(()=>{let a=document.getElementById("preview-iframe");a!=null&&a.contentWindow&&a.contentWindow.postMessage("voxelsite:reload-css","*")},300)}catch(n){console.error("[VX History] Redo error:",n),W("Redo failed",!0)}}function La(){return setTimeout(()=>zt(),0),`
  ...
  `}async function zt(){var D,C,H,O,V,te,Z;let e=document.getElementById("settings-content");if(!e)return;let[t,s,n,o,i,a,r]=await Promise.all([E.get("/settings"),E.get("/settings/system"),E.get("/settings/mail"),E.get("/settings/usage"),E.get("/files/content?path="+encodeURIComponent("assets/data/memory.json")),E.get("/files/content?path="+encodeURIComponent("assets/data/design-intelligence.json")),E.get("/settings/logs")]),l=((D=r.data)==null?void 0:D.logs)||[],c=((C=t.data)==null?void 0:C.settings)||{},u=((H=s.data)==null?void 0:H.system)||{},p=c.site_favicon||null,d=p?`/${p}?v=${Date.now()}`:"/favicon.ico?v="+Date.now(),v=null,m=null;try{i.ok&&((O=i.data)!=null&&O.content)&&(v=JSON.parse(i.data.content))}catch{}try{a.ok&&((V=a.data)!=null&&V.content)&&(m=JSON.parse(a.data.content))}catch{}let f=v||m,b=o.data||{models:[],totals:{request_count:0,total_input_tokens:0,total_output_tokens:0}},h=c.available_providers||{},g=((te=n.data)==null?void 0:te.config)||{},w=((Z=n.data)==null?void 0:Z.presets)||{},x=Object.keys(h),$=c.ai_provider||"claude",_=(h[$]||{name:"Claude",models:[],config_fields:[]}).config_fields||[],R=c[`ai_${$}_model`]||"",F=c[`ai_${$}_api_key_set`]||!1,ee=x.map(N=>{let oe=h[N];return`<option value="${y(N)}" ${N===$?"selected":""}>${y(oe.name)}</option>`}).join(""),X="";for(let N of _)N.key==="api_key"?X+=`
        <div>
    ...
    <div class="vs-settings-card" id="api-access-card">
      <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 16px;">
        ...
        <a href="/_studio/api/agent/v1/schema" target="_blank" rel="noopener" class="vs-btn vs-btn-ghost vs-btn-xs" style="color: var(--vs-text-ghost); white-space: nowrap; text-decoration: none;">
          ${k.externalLink} View API schema
        </a>
      </div>
      <div class="flex flex-col gap-4">
        <div style="display: flex; align-items: center; gap: 10px;">
...
A page reload is required after the update completes.`)){t.classList.add("hidden"),n.classList.add("hidden"),s.classList.remove("hidden"),i.textContent=`Uploading ${d.name}...`;try{let h=new FormData;h.append("update_zip",d);let g=P.get("sessionToken"),w=await fetch("/_studio/api/router.php?_path=%2Fupdate%2Fupload",{method:"POST",credentials:"same-origin",headers:g?{"X-VS-Token":g}:{},body:h}),x=w.headers.get("content-type")||"",$;if(!x.includes("application/json")){let R=await w.text();if(R.includes("POST Content-Length")||R.includes("upload_max_filesize")||R.includes("exceeds")){u("Server Upload Limit Exceeded",`The file (${(d.size/1024/1024).toFixed(1)} MB) exceeds your server's PHP upload limit. Increase <code>upload_max_filesize</code> and <code>post_max_size</code> in php.ini, then restart your web server.`);return}u("Upload Failed","The server returned an unexpected response. Check your PHP error log for details.");return}$=await w.json(),s.classList.add("hidden"),n.classList.remove("hidden");let B=document.getElementById("vs-update-result-icon"),_=document.getElementById("vs-update-result-message");if($.ok){let R=$.data;B.innerHTML='<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="var(--vs-success)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>',_.innerHTML=`
  ...
  `}async function gd(){var a,r,l,c,u,p;let e=document.getElementById("actions-list-container");if(!e)return;(a=document.getElementById("btn-new-action"))==null||a.addEventListener("click",async()=>{let d=await Ta();d!=null&&d.ok&&d.actionId&&(window.location.hash=`#/actions/${d.actionId}`)});let t=document.getElementById("bar-settings-card");if(t){let x=function($){let B=document.getElementById("bar-color-swatch"),_=document.getElementById("bar-brand-hex"),R=document.getElementById("bar-brand-color");B&&(B.style.background=$),_&&_!==document.activeElement&&(_.value=$),R&&(R.value=$),document.querySelectorAll(".bar-color-preset").forEach(F=>{F.style.borderColor=F.dataset.color.toLowerCase()===$.toLowerCase()?"var(--vs-text-primary)":"transparent"})},{ok:d,data:v}=await E.get("/agentic/actions/bar-settings"),m=d&&(v==null?void 0:v.settings)||{theme:"bottom-bar",visibility:"all-pages"},f=m.theme||"bottom-bar",b=m.visibility||"all-pages",h={"bottom-bar":`<svg viewBox="0 0 120 72" fill="none" xmlns="http://www.w3.org/2000/svg" style="width: 100%; height: auto;">
    ...
    `,document.querySelectorAll(".bar-theme-option").forEach($=>{$.addEventListener("click",async()=>{let B=$.dataset.theme;document.querySelectorAll(".bar-theme-option").forEach(R=>{let F=R.dataset.theme===B;R.style.borderColor=F?"var(--vs-accent)":"var(--vs-border-subtle)",R.style.background=F?"color-mix(in srgb, var(--vs-accent) 5%, var(--vs-bg-surface))":"var(--vs-bg-surface)",R.style.color=F?"var(--vs-accent)":"var(--vs-text-ghost)",R.classList.toggle("active",F);let ee=R.querySelector("span");ee&&(ee.style.color=F?"var(--vs-accent)":"var(--vs-text-secondary)");let X=R.querySelector('[style*="position: absolute"]');if(X&&!F&&X.remove(),F&&!R.querySelector('[style*="position: absolute"]')){let q=document.createElement("div");q.style.cssText="position:absolute;top:8px;right:8px;width:16px;height:16px;background:var(--vs-accent);border-radius:50%;display:flex;align-items:center;justify-content:center;",q.innerHTML='<svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>',R.appendChild(q)}});let{ok:_}=await E.put("/agentic/actions/bar-settings",{theme:B});_&&($.style.boxShadow="0 0 0 3px var(--vs-accent-dim)",setTimeout(()=>$.style.boxShadow="",400),M("Bar style updated","success"))})}),(r=document.getElementById("bar-visibility"))==null||r.addEventListener("change",async $=>{let{ok:B}=await E.put("/agentic/actions/bar-settings",{visibility:$.target.value});B&&M("Bar visibility updated","success")}),document.querySelectorAll(".bar-scheme-btn").forEach($=>{$.addEventListener("click",async()=>{let B=$.dataset.scheme;document.querySelectorAll(".bar-scheme-btn").forEach(R=>{let F=R.dataset.scheme===B;R.style.background=F?"var(--vs-accent)":"var(--vs-bg-surface)",R.style.color=F?"#fff":"var(--vs-text-secondary)"});let{ok:_}=await E.put("/agentic/actions/bar-settings",{color_scheme:B});_&&M("Color scheme updated","success")})}),(l=document.getElementById("bar-brand-color"))==null||l.addEventListener("input",$=>{x($.target.value)}),(c=document.getElementById("bar-brand-color"))==null||c.addEventListener("change",async $=>{let{ok:B}=await E.put("/agentic/actions/bar-settings",{brand_color:$.target.value});B&&M("Brand color updated","success")}),(u=document.getElementById("bar-brand-hex"))==null||u.addEventListener("change",async $=>{let B=$.target.value.trim();if(B.startsWith("#")||(B="#"+B),/^#[0-9a-fA-F]{3}([0-9a-fA-F]{3})?$/.test(B)){x(B);let{ok:_}=await E.put("/agentic/actions/bar-settings",{brand_color:B});_&&M("Brand color updated","success")}}),document.querySelectorAll(".bar-color-preset").forEach($=>{$.addEventListener("click",async()=>{let B=$.dataset.color;x(B);let{ok:_}=await E.put("/agentic/actions/bar-settings",{brand_color:B});_&&M("Brand color updated","success")})}),x(m.brand_color||"#EA580C")}let{ok:s,data:n}=await E.get("/agentic/actions");if(!s||!n){e.innerHTML='<div class="text-sm text-vs-error py-6">Failed to load actions.</div>';return}let o=n.actions||[];if(!o.length){e.innerHTML=`
        ...
        <div class="vs-modal-body" style="padding: 20px;">
          ...
          ">
            ${n.map(l=>`
              ...
              ">
                <span style="display: flex; align-items: center; justify-content: center; width: 40px; height: 40px; border-radius: var(--radius-md); background: var(--vs-bg-raised); color: var(--vs-accent);">${md[l.id]||k.zap}</span>
  ...
  `}async function Fn(e){var c,u,p,d,v,m,f,b,h,g,w,x,$,B,_,R,F,ee,X,q;let t=document.getElementById("action-detail-header"),s=document.getElementById("action-detail-body"),n=document.getElementById("action-records");if(!t)return;let{ok:o,data:i}=await E.get(`/agentic/actions/${encodeURIComponent(e)}`);if(!o||!i){t.innerHTML='<div class="text-sm text-vs-error py-6">Action not found.</div>',s&&(s.innerHTML=""),n&&(n.innerHTML="");return}let a=i.action,r=i.stats||{},l=a.active;if(t.innerHTML=`
...
Option 3`}" style="height: auto; resize: vertical; min-height: 64px;">${y(Ae)}</textarea>
  ...
  `}async function hd(){let e=document.getElementById("forms-list");if(!e)return;let{ok:t,data:s}=await E.get("/forms");if(!t||!s){e.innerHTML='<div class="text-sm text-vs-error py-6">Failed to load forms.</div>';return}let n=s.forms||[];if(!n.length){e.innerHTML=`
      <div class="vs-empty-state">
        <div class="vs-empty-state-inner">
  ...
  `;let r=document.getElementById("form-filter-status"),l=document.getElementById("form-filter-source"),c=document.getElementById("form-filter-search"),u=null,p=()=>zn(e,1);r==null||r.addEventListener("change",p),l==null||l.addEventListener("change",p),c==null||c.addEventListener("input",()=>{clearTimeout(u),u=setTimeout(p,300)}),(d=document.getElementById("btn-export-csv"))==null||d.addEventListener("click",async()=>{let m=document.getElementById("btn-export-csv"),f=m.innerHTML;m.innerHTML=`${k.loader} Exporting...`,m.disabled=!0;try{let b=await fetch(`/_studio/api/router.php?_path=${encodeURIComponent("/forms/"+e+"/submissions/export")}`,{credentials:"same-origin"});if(!b.ok)throw new Error("Export failed");let h=await b.blob(),g=URL.createObjectURL(h),w=document.createElement("a");w.href=g,w.download=`${e}_submissions_${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(w),w.click(),w.remove(),URL.revokeObjectURL(g),M("CSV downloaded","success")}catch{M("Failed to export CSV","error")}m.innerHTML=f,m.disabled=!1}),(v=document.getElementById("btn-upgrade-to-action"))==null||v.addEventListener("click",async()=>{var g,w;if(Js()||Zs())return;let m=(i.fields||[]).length;if(!await we({title:"Upgrade to Agent Action",description:`This will create a new agent action with${m>0?` the ${m} field${m!==1?"s":""} from`:""} this form. It starts as a draft so you can review before going live. Your original form stays unchanged.`,confirmLabel:"Create Action"}))return;let b=document.getElementById("btn-upgrade-to-action"),h=b.innerHTML;b.innerHTML=`${k.loader} Converting...`,b.disabled=!0,b.style.opacity="0.6";try{let x={text:"text",email:"email",number:"number",select:"select",date:"date",textarea:"textarea",tel:"tel",url:"url",checkbox:"checkbox",radio:"radio",hidden:"hidden"},$=[],B=0;(i.fields||[]).forEach(q=>{let le=x[q.type];if(!le){B++;return}let J={name:q.name,label:q.label||q.name,type:le,required:q.required||!1};(le==="select"||le==="radio")&&q.options&&(J.options=q.options),q.placeholder&&(J.placeholder=q.placeholder),$.push(J)}),B>0&&M(`${B} file upload field(s) skipped \u2014 actions don't support file uploads.`,"warning");let _=e.replace(/[^a-z0-9-]/gi,"-").replace(/-+/g,"-").replace(/^-|-$/g,""),R=Date.now().toString(36).slice(-4),F={id:_+"-"+R,name:i.name||e,description:i.description||`Converted from form: ${e}`,category:"general",icon:"circle",active:!1,fields:$,responses:{success:"Thank you! Your submission has been received. Your confirmation code is {confirmation_code}."}},{ok:ee,data:X}=await E.post("/agentic/actions",F);if(ee&&(X!=null&&X.action))M(`"${X.action.name}" created as agent action`,"success"),window.location.hash=`#/actions/${X.action.id}`;else{let le=(((g=X==null?void 0:X.error)==null?void 0:g.code)||"")==="already_exists"?"An action based on this form already exists. Check the Actions tab.":((w=X==null?void 0:X.error)==null?void 0:w.message)||"Failed to create action";M(le,"error"),b.innerHTML=h,b.disabled=!1,b.style.opacity=""}}catch{M("Failed to convert form to action","error"),b.innerHTML=h,b.disabled=!1,b.style.opacity=""}}),await zn(e,1)}async function zn(e,t=1){var b,h,g;let s=document.getElementById("form-submissions");if(!s)return;let n=((b=document.getElementById("form-filter-status"))==null?void 0:b.value)||"all",o=((h=document.getElementById("form-filter-source"))==null?void 0:h.value)||"all",i=((g=document.getElementById("form-filter-search"))==null?void 0:g.value)||"",a=`/forms/${encodeURIComponent(e)}/submissions?page=${t}&per_page=20`;n!=="all"&&(a+=`&status=${encodeURIComponent(n)}`),o!=="all"&&(a+=`&source=${encodeURIComponent(o)}`),i&&(a+=`&search=${encodeURIComponent(i)}`);let{ok:r,data:l}=await E.get(a);if(!r||!l){s.innerHTML='<div class="text-sm text-vs-error py-4">Failed to load submissions.</div>';return}let c=l.submissions||[],u=l.total||0,p=l.per_page||20,d=Math.ceil(u/p);if(!c.length){s.innerHTML=`
    ...
    `;return}let{data:v}=await E.get(`/forms/${encodeURIComponent(e)}`),m=v==null?void 0:v.form,f={};m!=null&&m.fields&&m.fields.forEach(w=>{f[w.name]=w.label||w.name}),s.innerHTML=`
  ...
  `}async function Qs(e="all"){var h;let t=document.getElementById("assets-grid");if(!t)return;let s=document.getElementById("btn-upload-asset"),n=document.getElementById("asset-file-input");s&&n&&(s.onclick=()=>n.click(),n.onchange=async()=>{n.files.length!==0&&(await ja(n.files),n.value="",Qs(e))});let o=document.getElementById("asset-dropzone");o&&(o.onclick=g=>{g.target.closest("button")||n==null||n.click()},o.ondragover=g=>{g.preventDefault(),o.classList.add("is-dragover")},o.ondragleave=()=>{o.classList.remove("is-dragover")},o.ondrop=async g=>{g.preventDefault(),o.classList.remove("is-dragover"),g.dataTransfer.files.length>0&&(await ja(g.dataTransfer.files),Qs(e))});let i=document.getElementById("asset-filters");i&&i.querySelectorAll("[data-filter]").forEach(g=>{g.onclick=()=>{i.querySelectorAll("[data-filter]").forEach(w=>{w.className="vs-device-btn"}),g.className="vs-device-btn vs-device-btn-active",Qs(g.dataset.filter)}});let a=e==="code",r=!a&&e!=="all"?`?category=${e}`:"",{ok:l,data:c}=await E.get(`/assets${r}`);if(!l||!((h=c==null?void 0:c.assets)!=null&&h.length)){t.innerHTML=`
    ...
    `;let g=document.getElementById("btn-empty-upload"),w=document.getElementById("btn-upload-asset");g&&w&&g.addEventListener("click",()=>w.click());return}let u=c.assets;if(a&&(u=u.filter(g=>g.category==="css"||g.category==="js"),u.length===0)){t.innerHTML=`
      ...
      `;return}let p=["jpg","jpeg","png","gif","webp","svg","ico"],d=u.filter(g=>g.category==="images"&&p.includes(g.extension)),v=u.filter(g=>!p.includes(g.extension)||g.category!=="images");function m(g,w){return g==="css"?k.fileCode:g==="js"?k.fileCode:g==="json"?k.fileJson:g==="pdf"?k.filePdf:["woff2","woff","ttf","otf"].includes(g)?k.type:["mp4","webm"].includes(g)?k.film:["mp3","wav","ogg"].includes(g)?k.music:["txt","md","csv"].includes(g)?k.fileText:["doc","docx","xls","xlsx"].includes(g)?k.fileText:w==="images"?k.image:k.fileText}let f=["css","js","json","svg"],b="";d.length>0&&(b+='<div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 mb-4">',d.forEach((g,w)=>{var _;let x=Co(g.size),$=g.width?`${g.width}\xD7${g.height}`:"",B=g.extension==="svg";b+=`
  ...
  `,(i=document.getElementById("btn-create-snapshot"))==null||i.addEventListener("click",()=>{var l,c;(l=window.demoGuard)!=null&&l.call(window)||(c=window.viewerGuard)!=null&&c.call(window)||qa()});let t=document.getElementById("snapshots-list");if(!t)return;let{ok:s,data:n}=await E.get("/snapshots");if(!s||!((a=n==null?void 0:n.snapshots)!=null&&a.length)){t.innerHTML=`
      <div class="vs-empty-state">
        <div class="vs-empty-state-inner">
          <div class="vs-empty-state-icon">
  ...
  `,_d(t)}function _d(e){e.querySelectorAll("[data-preview-id]").forEach(t=>{t.addEventListener("click",()=>{let s=JSON.parse(t.dataset.snap);Dd(s)})}),e.querySelectorAll("[data-restore-id]").forEach(t=>{t.addEventListener("click",async()=>{var a,r;if((a=window.demoGuard)!=null&&a.call(window)||(r=window.viewerGuard)!=null&&r.call(window))return;let s=t.dataset.restoreId;if(!await we({title:"Restore Snapshot",description:"This will overwrite your current preview. A safety snapshot of your current state will be created automatically.",confirmLabel:"Restore"}))return;t.innerHTML=`${k.rotateCcw} Restoring\u2026`,t.disabled=!0;let{ok:o,error:i}=await E.post(`/snapshots/${s}/restore`);o?(M("Snapshot restored.","success"),Wn()):(M((i==null?void 0:i.message)||"Failed to restore snapshot.","error"),t.innerHTML=`${k.rotateCcw} Restore`,t.disabled=!1)})}),e.querySelectorAll("[data-delete-snap-id]").forEach(t=>{t.addEventListener("click",async()=>{var a,r;if((a=window.demoGuard)!=null&&a.call(window)||(r=window.viewerGuard)!=null&&r.call(window))return;let s=t.dataset.deleteSnapId;if(!await we({title:"Delete Snapshot",description:"This snapshot will be removed permanently.",confirmLabel:"Delete",danger:!0}))return;t.innerHTML="Deleting\u2026",t.disabled=!0;let{ok:o,error:i}=await E.delete(`/snapshots/${s}`);o?(M("Snapshot deleted.","success"),Wn()):(M((i==null?void 0:i.message)||"Failed to delete snapshot.","error"),t.innerHTML=`${k.trash2}`,t.disabled=!1)})})}function sn(){var u;let e=document.getElementById("vs-design-save-overlay");e&&e.remove();let t=P.get("siteName")||"",s=document.createElement("div");s.id="vs-design-save-overlay",s.className="vs-modal-overlay",s.innerHTML=`
...
`;window.location.hash="#/chat",setTimeout(()=>{let i=document.getElementById("prompt-input");i&&(i.value=o,i.focus(),i.style.height="auto",i.style.height=i.scrollHeight+"px")},150)}async function tr(e){if(rn()||ln())return;await cs();let t,s,n;e?(t=e.title||"",s=e.body||"",n=e.id):({title:t,body:s}=ii(),n=Ie);let{ok:o,error:i}=await E.post("/cards",{title:t||"Untitled",body:s,column_name:"todo",source_note_id:n});o?M("Card added to Board.","success"):M((i==null?void 0:i.message)||"Failed to add card.","error")}function zd(e,t){var a;(a=document.getElementById("vs-note-ctx"))==null||a.remove();let s=_e.find(r=>r.id===t);if(!s)return;let n=s.pinned==1,o=document.createElement("div");o.id="vs-note-ctx",o.className="vs-note-context-menu",o.style.left=`${e.clientX}px`,o.style.top=`${e.clientY}px`,o.innerHTML=`
  ...
  `}async function st(){var o;let{ok:e,data:t}=await E.get("/cards");if(!e){M("Failed to load board.","error");return}let s=(t==null?void 0:t.cards)||[];P.set("cards",s),P.set("cardsLoaded",!0),Wd(s);let n=await E.get("/cards/archived");if(n.ok){let i=((o=n.data)==null?void 0:o.cards)||[];Yd(i.length)}}function Wd(e){let t=Cs();for(let s of un){let n=e.filter(a=>a.column_name===s.id),o=document.querySelector(`[data-col-cards="${s.id}"]`),i=document.querySelector(`[data-count="${s.id}"]`);if(i&&(i.textContent=n.length),!!o){if(n.length===0){s.id==="todo"&&e.length===0?o.innerHTML=t?`<div class="vs-board-empty">
            ...
            </div>`:t?o.innerHTML='<div class="vs-board-drop-zone">Drop a card here</div>':o.innerHTML="";continue}if(o.innerHTML=n.map(a=>a.id===He?ar(a,s,t):Gd(a,s,t)).join(""),He){let a=o.querySelector(`[data-card-id="${He}"].vs-board-card-expanded`);a&&t&&rr(a,He)}}}}function Gd(e,t,s){let n=e.body?`<div class="vs-board-card-body">${y(e.body.substring(0,200))}</div>`:"",o=e.linked_page?`<div class="vs-board-card-footer"><span class="vs-board-card-link" data-page="${pe(e.linked_page)}"><span class="vs-board-card-link-icon">${k.link}</span>${y(pr(e.linked_page))}</span></div>`:"";return`
      ...
      <div class="vs-board-card vs-board-card-expanded"
        ...
        ${e.linked_page?`
          <div class="vs-board-card-footer">
            <span class="vs-board-card-link" data-page="${pe(e.linked_page)}"><span class="vs-board-card-link-icon">${k.link}</span>${y(pr(e.linked_page))}</span>
          </div>
        `:""}
        <div class="vs-board-card-meta">
          Created ${pn(e.created_at)}${e.updated_at!==e.created_at?` \xB7 Updated ${pn(e.updated_at)}`:""}
  ...
  `}function _c(e){let t={index:"home",home:"home",about:"users","about-us":"users",team:"users",contact:"mail","contact-us":"mail",services:"briefcase",work:"briefcase",portfolio:"briefcase",projects:"briefcase",blog:"book",news:"book",articles:"book",posts:"book",shop:"shoppingBag",store:"shoppingBag",products:"shoppingBag",pricing:"shoppingBag",faq:"globe",help:"globe",support:"globe"},s=(e||"").toLowerCase().replace(/[^a-z0-9-]/g,"");return k[t[s]||"layoutGrid"]||k.layoutGrid}function yr(e){et.navigate("chat"),setTimeout(()=>{let t=document.getElementById("prompt-input");t&&(t.value=e,t.focus(),t.style.height="auto",t.style.height=t.scrollHeight+"px")},150)}function Ac(){let e=P.get("user")||{};return setTimeout(()=>Pc(),0),`
    <div>
      <div class="vs-page-header">
  ...
  `}function Pc(){let e=document.getElementById("btn-save-profile"),t=document.getElementById("profile-info-feedback");e&&e.addEventListener("click",async()=>{var c,u,p,d;let o=(u=(c=document.getElementById("profile-name"))==null?void 0:c.value)==null?void 0:u.trim(),i=(d=(p=document.getElementById("profile-email"))==null?void 0:p.value)==null?void 0:d.trim();if(!o||o.length<2){t&&(t.textContent="Name must be at least 2 characters.",t.className="text-sm text-vs-error");return}e.disabled=!0,e.textContent="Saving...";let{ok:a,error:r,data:l}=await E.put("/auth/profile",{name:o,email:i});e.disabled=!1,e.textContent="Save Profile",a&&(l!=null&&l.user)?(P.set("user",l.user),t&&(t.textContent="Profile updated.",t.className="text-sm text-vs-success"),setTimeout(()=>qe(),800)):t&&(t.textContent=(r==null?void 0:r.message)||"Failed to update profile.",t.className="text-sm text-vs-error")});let s=document.getElementById("btn-save-password"),n=document.getElementById("profile-pw-feedback");s&&s.addEventListener("click",async()=>{var c,u,p;let o=((c=document.getElementById("profile-current-pw"))==null?void 0:c.value)||"",i=((u=document.getElementById("profile-new-pw"))==null?void 0:u.value)||"",a=((p=document.getElementById("profile-confirm-pw"))==null?void 0:p.value)||"";if(!o){n&&(n.textContent="Current password is required.",n.className="text-sm text-vs-error");return}if(i.length<8){n&&(n.textContent="New password must be at least 8 characters.",n.className="text-sm text-vs-error");return}if(i!==a){n&&(n.textContent="Passwords do not match.",n.className="text-sm text-vs-error");return}s.disabled=!0,s.textContent="Updating...";let{ok:r,error:l}=await E.put("/auth/password",{current_password:o,new_password:i});s.disabled=!1,s.textContent="Update Password",r?(document.getElementById("profile-current-pw").value="",document.getElementById("profile-new-pw").value="",document.getElementById("profile-confirm-pw").value="",n&&(n.textContent="Password updated.",n.className="text-sm text-vs-success")):n&&(n.textContent=(l==null?void 0:l.message)||"Failed to update password.",n.className="text-sm text-vs-error")})}function Rc(){let e=document.getElementById("conversation-history-panel");if(!e)return;e.classList.contains("hidden")?(e.classList.remove("hidden"),Dc()):e.classList.add("hidden")}async function Dc(){let e=document.getElementById("conversation-list");if(!e)return;e.innerHTML='<div class="px-4 py-3 text-xs text-vs-text-ghost text-center">Loading...</div>';let{ok:t,data:s,error:n}=await E.get("/ai/conversations");if(!t||!(s!=null&&s.conversations)){e.innerHTML=`<div class="px-4 py-3 text-xs text-vs-text-ghost text-center">${y((n==null?void 0:n.message)||"Could not load conversations.")}</div>`;return}let o=s.conversations,i=P.get("activeConversationId");if(o.length===0){e.innerHTML='<div class="px-4 py-3 text-xs text-vs-text-ghost text-center">No conversations yet. Start chatting!</div>';return}e.innerHTML=o.map(a=>{let r=a.id===i,l=a.title||"Untitled conversation",c=a.updated_at?new Date(a.updated_at).toLocaleDateString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):"";return`
    ...
    `}).join(""),e.querySelectorAll("[data-conversation-id]").forEach(a=>{a.addEventListener("click",()=>{let r=a.dataset.conversationId;po(r);let l=document.getElementById("conversation-history-panel");l&&l.classList.add("hidden")})})}async function po(e){let t=document.getElementById("chat-messages");if(!t)return;t.innerHTML='<div class="flex items-center justify-center h-full text-sm text-vs-text-ghost">Loading conversation...</div>';let{ok:s,data:n,error:o}=await E.get(`/ai/conversations/${e}`);if(!s||!(n!=null&&n.conversation)){P.set("activeConversationId",null),vo(null);try{localStorage.removeItem("vs-active-conversation")}catch{}t.innerHTML=Ts(),Ss();return}let i=n.conversation,a=i.prompts||[];P.set("activeConversationId",e),vo(i.page_scope||null);try{localStorage.setItem("vs-active-conversation",e)}catch{}if(a.length===0){t.innerHTML=Ts(),Ss();return}let r="",l=!1;for(let c of a){let{text:u,images:p,webRefUrl:d}=op(c.user_prompt),v=p.length>0?`<div class="vs-msg-user-images">${p.map(f=>`<img src="${f}" class="vs-msg-user-image" />`).join("")}</div>`:"",m=d?`<div class="vs-msg-user-webref"><a href="${pe(d)}" target="_blank" rel="noopener" title="${pe(d)}">${k.globe} <span>${y(Ns(d))}</span></a></div>`:"";if(r+=`
      <div class="mb-5">
...
`+ke:ke,Ye.focus(),Ye.style.height="auto",Ye.style.height=Math.min(Ye.scrollHeight,200)+"px",Ye.selectionStart=Ye.selectionEnd=Ye.value.length,Me.textContent="\u2713 Added",Me.style.opacity="1",setTimeout(()=>{Me.textContent="Add to chat \u2192",Me.style.opacity="0.7"},1500)}),b()},onWarning(T){T.toLowerCase().includes("truncat")||B&&(B.innerHTML+=`
    ...
    <div class="vs-login-backdrop">
      ...
      <button id="btn-login-theme" class="vs-login-theme-toggle"
        ...
        ${(P.get("theme")||"light")==="light"?k.sun:k.moon}
      </button>
    </div>
  `;let e=document.getElementById("login-password"),t=document.getElementById("btn-toggle-pw");t&&e&&t.addEventListener("click",()=>{let d=e.type==="password";e.type=d?"text":"password",t.innerHTML=d?k.eyeOff:k.eye,t.title=d?"Hide password":"Show password"});let s=document.getElementById("btn-login-theme");s&&s.addEventListener("click",()=>{let d=Mn();s.style.transform="rotate(180deg) scale(0.8)",s.style.opacity="0",setTimeout(()=>{s.innerHTML=d==="light"?k.sun:k.moon,s.style.transform="rotate(0deg) scale(1)",s.style.opacity="1"},150)});function n(){document.querySelectorAll("[data-toggle-target]").forEach(d=>{d.addEventListener("click",()=>{let v=document.getElementById(d.dataset.toggleTarget);if(!v)return;let m=v.type==="password";v.type=m?"text":"password",d.innerHTML=m?k.eyeOff:k.eye,d.title=m?"Hide password":"Show password"})})}let o=document.getElementById("login-state"),i=document.getElementById("forgot-state"),a=document.getElementById("btn-forgot"),r=document.getElementById("btn-back-login");a&&a.addEventListener("click",async()=>{var v,m,f;o.classList.add("hidden"),i.classList.remove("hidden");let d=document.getElementById("forgot-content");try{let h=await(await fetch("/_studio/api/router.php?_path=%2Fauth%2Frecovery-mode")).json();(((v=h==null?void 0:h.data)==null?void 0:v.mode)||"file")==="email"?(d.innerHTML=`
            <div class="vs-login-header">
              <h1 class="vs-login-title">Reset Password</h1>
          ...
          `,n(),(f=document.getElementById("forgot-form"))==null||f.addEventListener("submit",async w=>{var R,F,ee;w.preventDefault();let x=document.getElementById("forgot-message"),$=(R=document.getElementById("forgot-email"))==null?void 0:R.value,B=(F=document.getElementById("forgot-new-password"))==null?void 0:F.value;if(!$||!B)return;let _=await E.post("/auth/reset-password",{email:$,new_password:B});_.ok?(x&&(x.textContent="Password reset. You can now sign in with your new password.",x.className="mb-5 px-4 py-3 text-sm rounded-xl border",x.style.cssText="background: color-mix(in srgb, var(--vs-success) 10%, transparent); border-color: color-mix(in srgb, var(--vs-success) 25%, transparent); color: var(--vs-success);",x.classList.remove("hidden")),setTimeout(()=>{i.classList.add("hidden"),o.classList.remove("hidden")},2500)):x&&(x.textContent=((ee=_.error)==null?void 0:ee.message)||"Reset failed. Make sure the .reset file exists in _data/.",x.className="mb-5 px-4 py-3 text-sm rounded-xl border",x.style.cssText="background: color-mix(in srgb, var(--vs-error) 10%, transparent); border-color: color-mix(in srgb, var(--vs-error) 25%, transparent); color: var(--vs-error);",x.classList.remove("hidden"))}))}catch{d.innerHTML=`
          <div class="vs-login-header">
            <h1 class="vs-login-title">Reset Password</h1>
