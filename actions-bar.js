...
(function () {
  ...
  // ── Detect demo root site (meta tag injected by index.php) ──
  var isDemoSite = !!document.querySelector('meta[name="voxelsite-demo"]');
  ...
  if (isDemoSite) {
    SUBMIT_URL = '/_studio/api/router.php?_path=%2Fagentic%2Fdemo-submit';
  }
